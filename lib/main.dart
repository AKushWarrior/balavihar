...
class BalviharApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      title: 'Balvihar Demo',
      theme: ThemeData.light().copyWith(textTheme: GoogleFonts.oswaldTextTheme().copyWith(bodyText1: GoogleFonts.merriweather(), bodyText2: GoogleFonts.merriweather(), subtitle1: GoogleFonts.merriweather(), subtitle2: GoogleFonts.merriweather())),
      initialRoute: '/',
      namedRoutes: {
